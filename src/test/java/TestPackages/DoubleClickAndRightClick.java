...
public class DoubleClickAndRightClick {
	...
	public void doubleClickTest() {
		...
		boolean actText = driver.findElement(By.xpath("//*[@id=\"doubleClickMessage\"]")).isDisplayed();
	...
	public void rightClickTest() {
		...
		boolean actText = driver.findElement(By.xpath("//*[@id=\"rightClickMessage\"]")).isDisplayed();
		Assert.assertTrue(true);
