...
public class TC001 {
			...
			List<WebElement>allnames=driver.findElements(By.xpath("//*[@id=\"product-list\"]/div/form/div/div[2]/div[1]/h4/a"));
			...
			List<WebElement>alItemPrices=driver.findElements(By.xpath("//*[@id=\"product-list\"]/div/form/div/div[2]/div[1]/div/span[1]"));
